    ...
    def list_sice_files(self):
        ...
        with progress_bar() as pbar:
            image_pattern = os.path.join(
                self.root, "unsupervised", self.split, "low", "*.*"
            )
...
if __name__ == "__main__":
    ...
    dm   = SICEUnsupervisedDataModule(**cfgs)
    dm.setup()
