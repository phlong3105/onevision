...
"""Div2K X8 dataset and datamodule
"""
...
@DATASETS.register(name="div2kx8")
class Div2KX8(ImageEnhancementDataset):
    """Div2K X8 dataset consists of 800 image pairs for super-resolution
    task.
    """
...
# MARK: - Div2KX8DataModule

@DATAMODULES.register(name="div2kx8")
class Div2KX8DataModule(DataModule):
    """Div2K X8 DataModule."""
    ...
    def setup(self, phase: Optional[Phase] = None):
        ...
        """
        console.log(f"Setup [red]Div2K X8[/red] datasets.")
