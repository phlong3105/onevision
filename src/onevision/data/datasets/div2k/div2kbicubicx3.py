...
"""Div2K BiCubic X3 dataset and datamodule.
"""
...
__all__ = [
    "Div2KBicubicX3",
    "Div2KBicubicX3DataModule"
]


# MARK: - Div2KBicubicX3

@DATASETS.register(name="div2kbicubicx3")
class Div2KBicubicX3(ImageEnhancementDataset):
    """Div2K Bicubic X3 dataset consists of 800 image pairs for super-resolution
    task.
    """
...
# MARK: - Div2KBicubicX3DataModule

@DATAMODULES.register(name="div2kbicubicx3")
class Div2KBicubicX3DataModule(DataModule):
    """Div2K Bicubic X3 DataModule."""
    ...
    def setup(self, phase: Optional[Phase] = None):
        ...
        """
        console.log(f"Setup [red]Div2K Bicubic X3[/red] datasets.")
        
        # NOTE: Assign train/val datasets for use in dataloaders
        if phase in [None, Phase.TRAINING]:
            self.train = Div2KBicubicX3(
                root=self.dataset_dir, split="train", **self.dataset_kwargs
            )
            self.val = Div2KBicubicX3(
...
if __name__ == "__main__":
    ...
    dm   = Div2KBicubicX3DataModule(**cfgs)
    dm.setup()
