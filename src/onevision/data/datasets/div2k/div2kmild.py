...
"""Div2K Mild dataset and datamodule.
"""
...
@DATASETS.register(name="div2kmild")
class Div2KMild(ImageEnhancementDataset):
    """Div2K Mild dataset consists of 800 image pairs for super-resolution
    task.
    """
...
# MARK: - Div2KMildDataModule

@DATAMODULES.register(name="div2kmild")
class Div2KMildDataModule(DataModule):
    """Div2K Mild DataModule."""
    ...
    def setup(self, phase: Optional[ModelState] = None):
        ...
        """
        console.log(f"Setup [red]Div2K Mild[/red] datasets.")
        
        # NOTE: Assign train/val datasets for use in dataloaders
        if phase in [None, ModelState.TRAINING]:
            self.train = Div2KMild(
