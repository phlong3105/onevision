...
"""Div2K Unknown X2 dataset and datamodule.
"""
...
class Div2KUnknownX2(ImageEnhancementDataset):
    """Div2K Unknown X2 dataset consists of 800 image pairs for super-resolution
    task.
    """
...
# MARK: - Div2KUnknownX2DataModule

@DATAMODULES.register(name="div2kunknownx2")
class Div2KUnknownX2DataModule(DataModule):
    """Div2K Unknown X2 DataModule."""
    ...
    def setup(self, phase: Optional[ModelState] = None):
        ...
        """
        console.log(f"Setup [red]Div2K Unknown X2[/red] datasets.")
        
        # NOTE: Assign train/val datasets for use in dataloaders
        if phase in [None, ModelState.TRAINING]:
            self.train = Div2KUnknownX2(
                root=self.dataset_dir, split="train", **self.dataset_kwargs
            )
            self.val = Div2KUnknownX2(
...
if __name__ == "__main__":
    ...
    dm   = Div2KUnknownX2DataModule(**cfgs)
    dm.setup()
