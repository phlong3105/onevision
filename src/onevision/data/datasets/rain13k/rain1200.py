...
"""Rain1200 dataset and datamodule.
"""
...
class Rain1200(ImageEnhancementDataset):
    """Rain1200 dataset consists 1200 pairs of rain/no-rain images."""
    ...
    def setup(self, phase: Optional[Phase] = None):
		...
		Args:
			phase (Phase, optional):
				...
				Default: `None`.
        """
        console.log(f"Setup [red]Rain1200[/red] datasets.")
