...
"""Rain100H dataset and datamodule.
"""
...
class Rain100H(ImageEnhancementDataset):
    """Rain100H dataset consists 100 pairs of rain/no-rain images."""
    ...
    def setup(self, phase: Optional[ModelState] = None):
		...
		Args:
			phase (ModelState, optional):
				...
				Default: `None`.
        """
        console.log(f"Setup [red]Rain100H[/red] datasets.")
