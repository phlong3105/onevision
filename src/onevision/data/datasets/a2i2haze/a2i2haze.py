...
"""A2I2-Haze dataset and datamodule.
"""
...
class A2I2Haze(ImageEnhancementDataset):
    ...
    Args:
        extras (Tasks, optional):
            The extra datasets to be used. One of the values in `self.extras`.
    ...
    def list_files(self):
        ...
        if self.split not in ["train"]:
            raise ValueError(f"A2I2-Haze dataset only supports `split`: "
