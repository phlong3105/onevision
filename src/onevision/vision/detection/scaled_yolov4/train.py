...
from onevision.vision.detection.scaled_yolov4.utils.general import check_file
from onevision.vision.detection.scaled_yolov4.utils.general import check_git_status
from onevision.vision.detection.scaled_yolov4.utils.general import check_img_size
from onevision.vision.detection.scaled_yolov4.utils.general import compute_loss
from onevision.vision.detection.scaled_yolov4.utils.general import fitness
from onevision.vision.detection.scaled_yolov4.utils.general import get_latest_run
from onevision.vision.detection.scaled_yolov4.utils.general import increment_dir
from onevision.vision.detection.scaled_yolov4.utils.general import labels_to_class_weights
from onevision.vision.detection.scaled_yolov4.utils.general import labels_to_image_weights
from onevision.vision.detection.scaled_yolov4.utils.general import plot_evolution
from onevision.vision.detection.scaled_yolov4.utils.general import plot_images
from onevision.vision.detection.scaled_yolov4.utils.general import plot_labels
from onevision.vision.detection.scaled_yolov4.utils.general import plot_results
from onevision.vision.detection.scaled_yolov4.utils.general import print_mutation
from onevision.vision.detection.scaled_yolov4.utils.general import strip_optimizer
from onevision.vision.detection.scaled_yolov4.utils.general import torch_distributed_zero_first
from onevision.vision.detection.scaled_yolov4.utils.google_utils import attempt_download
from onevision.vision.detection.scaled_yolov4.utils.torch_utils import init_seeds
...
def parse_opt():
    ...
    parser.add_argument(
        "--weights", default=os.path.join(scaled_yolov4_dir, "yolov4_p7_coco.pt"), type=str, help="initial weights path"
    )
