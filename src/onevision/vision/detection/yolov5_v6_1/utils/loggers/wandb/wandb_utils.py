...
from onevision.vision.detection.yolov5_v6_1.utils.datasets import img2label_paths
from onevision.vision.detection.yolov5_v6_1.utils.datasets import LoadImagesAndLabels
...
class WandbLogger():
    ...
    def __init__(self, opt, run_id=None, job_type='Training'):
        """
        - Initialize WandbLogger measurement
    ...
    def create_dataset_table(self, dataset: LoadImagesAndLabels, class_to_id: Dict[int, str], name: str = 'dataset'):
        ...
        arguments:
        dataset -- measurement of LoadImagesAndLabels class used to iterate over the data to build Table
