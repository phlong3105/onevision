...
"""MPRNet Desnow variant trained on Snow100K dataset.
"""
...
data = {
    ...
    # Datasets" name.
    "subset": ["snow100k"],
    # Sub-dataset name. One of: ["snow100k", "srrs"]. Can also be a list to
...
model = {
	...
	# Default: `-1`.mprnet_snow100k
    "loss": {"name": "charbonnier_edge_loss"},
	# Loss config.
    # Loss config.
    "metrics": {
		"train": [{"name": "psnr"}],
