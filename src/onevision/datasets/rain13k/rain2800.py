...
"""Rain2800 dataset and datamodule.
"""
...
class Rain2800(ImageEnhancementDataset):
    """Rain2800 dataset consists 2800 pairs of rain/no-rain images."""
    ...
    def setup(self, phase: Optional[Phase] = None):
		...
		Args:
			phase (Phase, optional):
				...
				Default: `None`.
        """
        console.log(f"Setup [red]Rain2800[/red] datasets.")
