...
"""Rain100 dataset and datamodule.
"""
...
class Rain100(ImageEnhancementDataset):
    """Rain100 dataset consists 100 pairs of rain/no-rain images."""
    ...
    def setup(self, phase: Optional[Phase] = None):
		...
		Args:
			phase (Phase, optional):
				...
				Default: `None`.
        """
        console.log(f"Setup [red]Rain100[/red] datasets.")
