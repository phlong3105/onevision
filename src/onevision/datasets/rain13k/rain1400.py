...
"""Rain1400 dataset and datamodule.
"""
...
class Rain1400(ImageEnhancementDataset):
    """Rain2800 dataset consists 1400 pairs of rain/no-rain images."""
    ...
    def setup(self, phase: Optional[Phase] = None):
		...
		Args:
			phase (Phase, optional):
				...
				Default: `None`.
        """
        console.log(f"Setup [red]Rain1400[/red] datasets.")
