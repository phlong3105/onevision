...
from onevision.file import list_subdirs
...
Where:
	...
	<score>          : Fscore in the DETECTION result file indicates the confidence of the predicted bounding box
					   enclosing an object instance.Fscore in GROUNDTRUTH file is set to 1 or 0. 1 indicates the bounding
...
if __name__ == "__main__":
	...
	if args.data_dir == "":
		data_dir = os.path.join(datasets_dir, "visdrone", "det2019")
	else:
