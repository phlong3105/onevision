...
"""Div2K BiCubic X4 dataset and datamodule
"""
...
class Div2KBicubicX4(ImageEnhancementDataset):
    """Div2K Bicubic X4 dataset consists of 800 image pairs for super-resolution
    task.
    """
...
if __name__ == "__main__":
    ...
    dm   = Div2KBicubicX4DataModule(**cfgs)
    dm.setup()
