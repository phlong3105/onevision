...
"""Div2K BiCubic dataset and datamodule.
"""
...
__all__ = [
    "Div2KBicubic",
    "Div2KBicubicDataModule"
]


# MARK: - Div2KBicubic

@DATASETS.register(name="div2kbicubic")
...
# MARK: - Div2KBicubicDataModule

@DATAMODULES.register(name="div2kbicubic")
class Div2KBicubicDataModule(DataModule):
    """Div2K Bicubic DataModule."""
    ...
    def setup(self, phase: Optional[Phase] = None):
        ...
        """
        console.log(f"Setup [red]Div2K Bicubic[/red] datasets.")
...
if __name__ == "__main__":
    ...
    dm   = Div2KBicubicDataModule(**cfgs)
    dm.setup()
