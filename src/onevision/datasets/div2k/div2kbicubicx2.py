...
__all__ = [
    "Div2KBicubicX2",
    "Div2KBicubicX2DataModule"
]


# MARK: - Div2KBicubicX2

@DATASETS.register(name="div2kbicubicx2")
class Div2KBicubicX2(ImageEnhancementDataset):
    """Div2K Bicubic X2 dataset consists of 800 image pairs for super-resolution
    task.
    """
...
# MARK: - Div2KBicubicX2DataModule

@DATAMODULES.register(name="div2kbicubicx2")
class Div2KBicubicX2DataModule(DataModule):
    """Div2K Bicubic X2 DataModule."""
    ...
    def setup(self, phase: Optional[Phase] = None):
        ...
        """
        console.log(f"Setup [red]Div2K Bicubic X2[/red] datasets.")
        
        # NOTE: Assign train/val datasets for use in dataloaders
        if phase in [None, Phase.TRAINING]:
            self.train = Div2KBicubicX2(
                root=self.dataset_dir, split="train", **self.dataset_kwargs
            )
            self.val = Div2KBicubicX2(
...
if __name__ == "__main__":
    ...
    dm   = Div2KBicubicX2DataModule(**cfgs)
    dm.setup()
