    ...
    def list_gladnet_files(self):
        ...
        with progress_bar() as pbar:
            ...
            for image_path in pbar.track(
                ...
                description=f"[bright_yellow]Listing GLADNet {self.split} images"
            ):
...
class GLADNetDataModule(DataModule):
    ...
    def __init__(
        self,
        dataset_dir: str = os.path.join(datasets_dir, "gladnet"),
        name       : str = "gladnet",
        *args, **kwargs
    ):
    ...
    def setup(self, phase: Optional[Phase] = None):
        ...
        """
        console.log(f"Setup [red]GLADNet[/red] datasets.")
