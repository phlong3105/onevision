...
from onevision.data import ImageClassificationDataset
...
from onevision.file import get_dirname
...
class ILSVRC2012ClsLocDataModule(DataModule):
    ...
    def __init__(
        self,
        dataset_dir: str = os.path.join(datasets_dir, "imagenet"),
